...
public class NotificationsController {
    ...
    public static void notify(final Context context, final String notificatioTicker, final int number) {
        ...
        @SuppressLint({"StringFormatInvalid", "LocalSuppress"}) final String text = res.getString(R.string.notification_text, notificatioTicker);

        Intent backIntent = new Intent(context, MainActivity.class);
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)

                .setDefaults(Notification.DEFAULT_ALL)
                .setSmallIcon(R.drawable.amber_gradient)
