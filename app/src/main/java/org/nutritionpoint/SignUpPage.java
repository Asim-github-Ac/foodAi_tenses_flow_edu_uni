...
import static org.nutritionpoint.LoginPage.isValidEmail;
import static org.nutritionpoint.LoginPage.isValidPassword;
...
public class SignUpPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button sign_up_btn = findViewById(R.id.sign_up_btn);
        ...
        final EditText phoneNumberView = findViewById(R.id.phoneNumber);
        final EditText orgView = findViewById(R.id.organizationName);
